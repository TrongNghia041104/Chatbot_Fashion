...
Nhóm ảnh phải có riêng các cách hỏi nhận diện như “đây là gì”, “sản phẩm này của tôi là gì”, “nhận diện món đồ này”; expected action là `identify_image_item`, không phải `profile_analysis`.
